...
class AmplitudeWidget(QtGui.QWidget):

    def __init__(self, parent):
        super(AmplitudeWidget, self).__init__()
    ...
    def handle_slider_change(self, value):
        ...
        # update plots
        self.parent.amp_widget.plot(self.parent.shares['time'], self.parent.shares['original'][:, 2])
        self.parent.amp_widget.plot(shares['time'], self.parent.shares['amp'], pen='b', clear=False)
